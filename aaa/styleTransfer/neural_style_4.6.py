...
def imsave(tensor, title=None):
    ...
    # plt.imshow(image)
    image.save('./results_c/{}.png'.format(title))
...
def style_transfer(style_file, content_file, trick, num_steps,
    ...
    white_img = image2Var(white_img).type(dtype)
    ...
    imsave(input_img.data, title='Input_{}_{}'.format(content_file[:8], trick))
    imsave(style_img.data, title='Input_{}_{}'.format(style_file[:6], trick))

    output = run_style_transfer(cnn,
                                content_img=trick_img,
                                style_img=style_img,
                                input_img=style_img,  # for initialization
                                num_steps=num_steps,
                                style_weight=style_weight,
                                content_weight=content_weight,
                                )
    imsave(output, title='{}_s_{}'.format(style_file[:-4], ''.join(style_layers_default)))
...
style_files = ['style2.png', 'style3.png', 'style4.png', 'style5.png', 'style6.png',
               'style8.png', 'style9.png', 'style21.jpg', 'style22.jpg', 'style24.png',
               'style27.png', 'style28.png']
content_files = ['content1.jpg', 'content2.jpg', 'content3.jpg', 'content4.jpg',
                 'content5.jpg', 'content6.jpg', 'content7.jpg', 'content8.jpg']
